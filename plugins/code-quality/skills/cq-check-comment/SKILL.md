...
description: |
  Use when validating AI-generated code review comments, PR feedback, static-analysis findings, or
  reviewer claims. Independently checks whether each reported issue is real, rates severity, and
  recommends accept, reject, or fix. Trigger for 'check this review', 'verify these comments', 'is
  this review report correct', or 'audit AI review feedback'.
context: fork
